...
crclut = [0x000000, 0x864CFB, 0x8AD50D, 0x0C99F6, 0x93E6E1, 0x15AA1A, 0x1933EC, 
...
# def genLookup(polynom, mask=None):
#     """
#     Generate lookup table for Qualcomm 24 bit cyclic redundancy check:
    
#         g(X) = sum_i=0^24 g_i X^i
#         g_i = 1, for i = [24, 23, 18, 17, 14, 11, 10, 7, 6, 5, 4, 3, 1, 0]
#         i.e. g_mask = 0b1 1000 0110 0100 1100 1111 1011
#                     = 0x1864CFB 
